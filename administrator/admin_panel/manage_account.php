        ...
        <div class = "logo_content">
            ...
            <ul class = "nav_list">
                    ...
                    <div class = "sub_certification_folder">
                        ...
                        <button id = "certificate" type ="button" onclick="loadContent('certificate_folder/certificate.php')">Admin Account</button>

                        <button id = "clearance" onclick="loadContent('user_register_folder/table.php')" >User Account</button>
