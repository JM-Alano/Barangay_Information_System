      ...
      confirmDeleteBtn.addEventListener("click", function() {
          ...
          xhr.open("POST", "/BIS/administrator/admin_panel/brgy_blotter/delete.php", true);
          ...
          xhr.onload = function() {
              if (xhr.status === 200) {
                  ...
                  window.location.href = "brgy_blotter/loading_delete.php";
          ...
          modal_delete.style.display = "none";
                ...
                // live search
                     ...
                     document.addEventListener("mouseover", function() {
                        ...
                        let deleteBtns = document.querySelectorAll(".delete_btns");
                        ...
                        confirmDeleteBtn.addEventListener("click", function() {
                            ...
                            // Send AJAX request to delete.php
                            let xhr = new XMLHttpRequest();
                            xhr.open("POST", "/BIS/administrator/admin_panel/brgy_resident_folder/delete.php", true);
                            xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
                            xhr.send("id=" + id);
                            xhr.onload = function() {
                                if (xhr.status === 200) {
                                    ...
                                    // Refresh page or update table
                                    window.location.href = "brgy_resident_folder/loading_delete.php";
