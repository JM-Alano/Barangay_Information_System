    ...
    <div class = "sidebar">
        <div class = "logo_content">
            ...
            <ul class = "nav_list">
                    ...
                    <div class = "sub_certification_folder">
                        ...
                        <a id = "admin_manage" href="administrator_account.php"  style = "color:#d4c603;" onclick="loadContent('admin_folder/admin_manage.php')">Admin Account</a><br>

                  

                        <a href="user_registered.php"  id = "end_user" >User Account</a>
                    </div>
                    <li>
        ...
        <div class = "dashboard_content">
                ...
                <div class = "main_content">
                                ...
                                <a href="/BIS/administrator/admin_panel/admin_folder/export.php"><button id = "create_import" style = "background-color:#d4b62f;">Export</button></a>
                                        <!-- SEARCH BUTTON -->
                  ...
                  <div id="modal_import" class="modal_import">
                                ...
                                <span class="closes" onclick="this.parentElement.parentElement.style.display='none'">&times;</span>
                                    ...
                                    <?php include('./admin_folder/import_temp.php')?>
                    </div>
                </div>
                  <!-- ADD FORM -->
                  <div id="modal_add_registered" class="modal_registered">
                          ...
                          <div  id = "searchresult" class = "table_div">
                                <?php include('./admin_folder/admin_manage.php'); ?>
           ...
           <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.7.1/jquery.min.js"></script>
            ...
            <script type = "text/javascript" >
                    ...
                    $("#live_search").keyup(function(){
                        ...
                        if(input != ""){
                            $.ajax({
                                url: "./admin_folder/livesearch.php",
                                method: "POST",
                                data: {input:input},
