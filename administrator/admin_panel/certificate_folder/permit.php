...
<?php require("../../../database/conn_db.php");
                ...
                $sql = "SELECT DISTINCT * FROM barangay_request WHERE request_document = 'Business Permit' ORDER BY id DESC LIMIT 12";
                ...
                if ($result->num_rows > 0) {?>
                  <div id = "searchresult">
                <table>
                        <caption>Business Permit Request</caption>
                        <tr>
                            <th>Profile</th>
                            <th>Fullname</th>
                                 ...
                                 <td class = "img"><img src="/BIS/asset/image/user_profile/<?php echo $profile; ?>" alt="" width = 500/></td>
                                    ...
                                    <td>
                                        ...
                                        <div id="form_up_del_official">
                                            ...
                                            <button id = "delete_official_btn" class = "delete_btn_id" data-id= <?php echo $row ["id"] ?>><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--!Font Awesome Free 6.7.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M135.2 17.7L128 32 32 32C14.3 32 0 46.3 0 64S14.3 96 32 96l384 0c17.7 0 32-14.3 32-32s-14.3-32-32-32l-96 0-7.2-14.3C307.4 6.8 296.3 0 284.2 0L163.8 0c-12.1 0-23.2 6.8-28.6 17.7zM416 128L32 128 53.2 467c1.6 25.3 22.6 45 47.9 45l245.8 0c25.3 0 46.3-19.7 47.9-45L416 128z"/></svg></button>
                                        </div>    
              ...
              <div id = "delete-modal_id" class = "delete-modal_id">
                        ...
                        <span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zm0-384c13.3 0 24 10.7 24 24l0 112c0 13.3-10.7 24-24 24s-24-10.7-24-24l0-112c0-13.3 10.7-24 24-24zM224 352a32 32 0 1 1 64 0 32 32 0 1 1 -64 0z"/></svg></span>
                                        <h2>Delete Confirmation</h2>
                                            ...
                                            <button id = "confirm-delete_id" id = "permit_red" class = "btn-delete_id">Delete</button>
                                            <button id = "cancel-delete_id" id = "permit_green" class = "btn-delete_id">Cancel</button>
                                            </div>
            </div>
             </div>
</body>
