document.addEventListener("mouseover", function() {
        ...
        let indigency_modal = document.getElementById("indigency-modal");
        let indigencyBtns = document.querySelectorAll(".indigency_btn");
        let confirmBtn = document.getElementById("confirm-indigency");        
    
    
        // Show modal on edit button click
        indigencyBtns.forEach(function(btn) {
        btn.addEventListener("click", function() {
            indigency_modal.style.display = "block";
