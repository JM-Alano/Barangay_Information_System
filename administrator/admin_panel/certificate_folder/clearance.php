                                 ...
                                 <tr class = "table_hover">
                                    ...
                                    <ul class="dropdown-contents">
                                        ...
                                        <li>
                                            ...
                                            <button id = "edit_list" class = "edit_btn_manage" data-id= <?php echo $row ["OR_no"] ?>>Edit List</button></li>
                                       <li><button id = "delete_official_btn" class = "delete_btn_manage" data-id= <?php echo $row ["OR_no"] ?>>Delete List</button></li>
                                    </ul>
