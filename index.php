...
<body>  
        ...
        <div>
            ...
            <p>Request Branagay Certification<br></p>
        ...
        <p>Request Branagay Indigency<br></p>
        <a href="user_login/user_login_page.php"><button class = "btn_proceed">Proceed</button></a>
        </div>
        ...
        <div>
            ...
            <p>Request Branagay Clearance<br></p>
            <a href="user_login/user_login_page.php"><button class = "btn_proceed">Proceed</button></a>
        </div>
        ...
        <div>
            ...
            <p>Request Branagay Cedula<br></p>
            <a href="user_login/user_login_page.php"><button class = "btn_proceed">Proceed</button></a>
        </div>
